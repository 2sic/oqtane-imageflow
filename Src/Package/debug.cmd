...
@REM Imageflow.Server 0.8.1
XCOPY "..\packages\imageflow.server\0.8.1\lib\net6.0\Imageflow.Server.dll" "..\..\..\oqtane.framework\Oqtane.Server\bin\Debug\net7.0\" /Y
@REM Imageflow.Server.HybridCache 0.8.1
XCOPY "..\packages\imageflow.server.hybridcache\0.8.1\lib\net6.0\Imageflow.Server.HybridCache.dll" "..\..\..\oqtane.framework\Oqtane.Server\bin\Debug\net7.0\" /Y
@REM Imazen.Common (>= 0.8.1)
XCOPY "..\packages\imazen.common\0.8.1\lib\netstandard2.0\Imazen.Common.dll" "..\..\..\oqtane.framework\Oqtane.Server\bin\Debug\net7.0\" /Y
@REM Imazen.HybridCache (>= 0.8.1) 
XCOPY "..\packages\imazen.hybridcache\0.8.1\lib\netstandard2.0\Imazen.HybridCache.dll" "..\..\..\oqtane.framework\Oqtane.Server\bin\Debug\net7.0\" /Y
@REM Imageflow.AllPlatforms (>= 0.10.0) 
XCOPY "..\packages\imageflow.allplatforms\0.10.0\lib\netstandard2.0\Imageflow.AllPlatforms.dll" "..\..\..\oqtane.framework\Oqtane.Server\bin\Debug\net7.0\" /Y
@REM Imageflow.Net (>= 0.10.0)
XCOPY "..\packages\imageflow.net\0.10.0\lib\netstandard2.0\Imageflow.Net.dll" "..\..\..\oqtane.framework\Oqtane.Server\bin\Debug\net7.0\" /Y
@REM Imageflow.NativeRuntime.osx-x86_64 (>= 2.0.0-preview5)
@REM Imageflow.NativeRuntime.ubuntu-x86_64 >= 2.0.0-preview5)
@REM Imageflow.NativeRuntime.win-x86 (>= 2.0.0-preview5)
@REM Imageflow.NativeRuntime.win-x86_64 >= 2.0.0-preview5) 
XCOPY "..\packages\imageflow.nativeruntime.win-x86_64\2.0.0-preview5\runtimes\win-x64\native\imageflow.dll" "..\..\..\oqtane.framework\Oqtane.Server\bin\Debug\net7.0\runtimes\win-x64\native\" /Y
